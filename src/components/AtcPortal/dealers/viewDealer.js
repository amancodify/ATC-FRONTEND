...
const ViewDealer = (props) => {
    ...
    let { name, party_code, address, firm_name, dealer_area, mobile, email, photo, opening_bal_done, is_damage_dealer } = singleDealersData || {};
            ...
            <div className="col-md-12 dealerview-section">
                <div className="row dealerview-main">
                    <div className="col-md-2 d-flex flex-column align-items-center justify-content-center">
                        <img className="userimg mt-1" src={photo ? photo : 'https://www.w3schools.com/howto/img_avatar.png'} alt="" />
                        ...
                        <div onClick={() => setMenuShow(!menuShow)}>
                            ...
                            {menuShow && (
                                <div className="menu-list" ref={ref}>
                                    ...
                                    <a className="d-flex align-items-center justify-content-end edit-main" href={`#/editprofile/${partyCode}`}>
                ...
                <div className="row product-view-main">
                    ...
                    <div className="actions">
                        <div className={`${cursorCss}`}>
                            <div className={`action-link ${disabledCss}`} onClick={() => setShowTransPopup(true)}>
                                New Transaction
                            </div>
                        </div>
